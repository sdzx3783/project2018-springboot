...
function morePendingMatters(){
 window.parent.frames.addToTab("/platform/bpm/task/pendingMatters.ht","待办/处理","10000002800009","/static/platform/images/transparent.png");
}
function alreadyMatters(){
 window.parent.frames.addToTab("/platform/bpm/processRun/alreadyCompletedMatters.ht","已办事项","10000002800007","/static/platform/images/transparent.png");
}
