    ...
    CustomForm = {
        ...
        initSubTable : function(){
            $('div[type=subtable]').each(function() {
                ...
                $(this).find('[formType="newrow"]').each(function() {
                    ...
                    if($(table).attr("tableName")=='week_plan_sbb' || $(table).attr("tableName")=='project_task_hour'){
                ...
                if(canWrite){
                    ...
                    table.find('[formType]:first:not(".forbidevent")').prev().bind("contextmenu", function(e) {
        ...
        handButton:function(table,canWrite){
            ...
            $(".add",table).click(function(){
                ...
                $('body').trigger('close.iframe');
                $('body').trigger('new.table');
            });
        ...
        getValidate : function(target) {
            return target.form({
                ...
                errorPlacement : function(el, msg) {
                    ...
                    if(parentTd){
                        var formTitle = parentTd.prev("td.formTitle, th, td");
                        //  找到td的前一个td或者th元素 给其添加一个红色的星号
                        if(formTitle){
                    ...
                    if(element.hasClass("myeditor")){
                        ...
                        //  处理 select checkbox radio类型的表单元素
                ...
                success : function(el) {
                    ...
                    if(element.hasClass("myeditor")){
                        ...
                        element.css("border","1px solid #dadfed");
                    }else if(element.is("select")||element.attr('type')&&(element.attr('type')=='checkbox'||element.attr('type')=='radio')){
