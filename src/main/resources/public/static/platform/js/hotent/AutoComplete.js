...
/**
 * 需要引用的样式及js<br>
 * &lt;link rel="stylesheet" href="${ctx}/static/platform/js/jquery-ui-portlet/lib/themes/jquery-ui.css"&gt;<br>
 * &lt;script type="text/javascript" src="${ctx}/static/platform/js/jquery-ui-portlet/lib/jquery-1.8.3.js"&gt;&lt;/script&gt;<br>
 * &lt;script src="${ctx}/static/platform/js/jquery-ui-portlet/lib/jquery.ui.core.js"&gt;&lt;/script&gt;<br>
 * &lt;script src="${ctx}/static/platform/js/jquery-ui-portlet/lib/jquery.ui.widget.js"&gt;&lt;/script&gt;<br>
 * &lt;script src="${ctx}/static/platform/js/jquery-ui-portlet/lib/jquery.ui.position.js"&gt;&lt;/script&gt;<br>
 * &lt;script src="${ctx}/static/platform/js/jquery-ui-portlet/lib/jquery.ui.menu.js"&gt;&lt;/script&gt;<br>
 * &lt;script src="${ctx}/static/platform/js/jquery-ui-portlet/lib/jquery.ui.autocomplete.js"&gt;&lt;/script&gt;<br>
 * &lt;script type="text/javascript" src="${ctx}/static/platform/js/util/json2.js"&gt;&lt;/script&gt;<br>
 * &lt;script src="${ctx}/static/platform/js/hotent/platform/form/CommonDialog.js"&gt;&lt;/script&gt;<br>
 */
