...
function singleOption(typeName,firstName,fistValue,secondName,secondValue,thirdName,thirdValue,fouthName,fouthValue
		,fifthName,fifthValue,sixthName,sixthValue){
...
function simpleSearch(){
    ...
    $items.each(function(index, item){
        ...
        var $item        = $(item).find(".oa-select, .oa-input");
