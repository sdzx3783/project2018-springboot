...
(function ($)
{
    ...
    //dialog 图片文件夹的路径 预加载
    $.ligerui.DialogImagePath = "../../lib/ligerUI/skins/Aqua/static/platform/images/win/";
    ...
    l.controls.Dialog.ligerExtend(l.core.Win, {
        ...
        _render: function ()
        {
            ...
            if(typeof (window.parent.cfgSealInfo) != 'undefined') {
                $('.l-dialog-btn-inner').eq(2).bind("click", function () {
                    window.parent.cfgSealInfo();
                });
            }
