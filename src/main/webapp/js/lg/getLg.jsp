...
<script type="text/javascript" src="${ctx}/static/platform/js/hotent/SysDialog.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/lg/util/SelectUtilLg.js"></script>
...
<script type="text/javascript" src="${ctx}/static/platform/js/lg/plugins/ligerGrid.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/lg/plugins/ligerDialog.js" ></script>
<script type="text/javascript" src="${ctx}/static/platform/js/lg/lgUtil.js"></script>
...
<script type="text/javascript" src="${ctx}/static/platform/js/lg/util/foldBoxLg.js" ></script>
