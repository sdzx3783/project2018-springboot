...
<script type="text/javascript" src="${ctx}/static/platform/js/ueditor1433/extend/officecontrol/officecontrolDialogController.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			var span;
			if (!targetEl) {//新增模式
				var span = $("<span class='officecontrol' parser='officeedit'></span>");
				$(element).append(span);
			} else {//编辑
				span=$(targetEl);
				span.empty();
