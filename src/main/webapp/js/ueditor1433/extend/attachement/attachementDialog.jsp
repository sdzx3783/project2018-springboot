...
<script type="text/javascript" src="${ctx}/static/platform/js/ueditor1433/extend/attachement/attachementDialogController.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			var span;
			if (!targetEl) {//新增模式
				span = $("<span class='attachement' parser='attachmentedit'></span>");
				$(element).append(span);
			} else {//编辑
				span = $(targetEl);
				span.empty();
			...
			span.append("<input type='text' /><a href='javascript:;' class='link attachement'>" + scope.external.buttoncontent + "</a>");
