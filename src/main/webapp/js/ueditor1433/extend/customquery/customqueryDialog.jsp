...
<script type="text/javascript">
	...
	dialog.onok = function() {
		...
		var zTree = $.fn.zTree.getZTreeObj("fields-tree"), nodes = zTree.getNodes(), fields = [];
	...
	function initFieldsDiv(data) {
		...
		data.name = mainTable.tableName + '(主表)';
	...
	function getFileds(tableId) {
		if (tableId) {
			var url = __ctx + '/platform/form/bpmFormTable/getTableById.ht?tableId=' + tableId + '&incHide=true';
				...
				<tr>
					...
					<td>
						<select id="bind-event">
							<option value="carriage_return" evtKey="keyup" evtCode="13">回车</option>
							<option value="valueChange" evtKey="change" evtCode="0">值变更</option>
						</select>
					</td>
				</tr>
			</table>
