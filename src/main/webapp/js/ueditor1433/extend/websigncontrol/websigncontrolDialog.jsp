...
<script type="text/javascript" src="${ctx}/static/platform/js/ueditor1433/extend/websigncontrol/websigncontrolDialogController.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			var span;
			if (!targetEl) {//新增模式
				span = $("<span class='websigncontrol' parser=''></span>");//TODO web印章的解释器还没写
				$(element).append(span);
			} else {//编辑
				span = $(targetEl);
				span.empty();
