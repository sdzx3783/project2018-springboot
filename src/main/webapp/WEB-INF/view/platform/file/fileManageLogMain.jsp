...
<style type="text/css">
	...
	<script type="text/javascript">
		...
		var globalType=new GlobalType(catKey,"glTypeTree",{onClick:onClick,expandByDepth:1});
		var formDefMenu=new FormDefMenu();
				
		function onClick(treeNode){
			var url="${ctx}/platform/file/fileManageLog/downloadOperList.ht";
...
<body>
   	<div id="defLayout" >
         <div position="left" title="文件分类管理" style="overflow: auto;float:left;width:100%">
         ...
         <div position="center">
        	<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/file/fileManageLog/downloadOperList.ht"></iframe>
         </div>
     </div>
</body>
</html>
