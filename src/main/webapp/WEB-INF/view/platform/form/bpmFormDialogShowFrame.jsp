...
<head>
    ...
    <style>
        ...
        @media screen and (max-width: 800px) {
        	...
        	.oa-paging-wrap .oa-button-label {
        		margin: 4px 0;
        	}
        }
    </style>
        ...
        <c:otherwise>
            <div class="panel">
                <div class="panel-top">
                    ...
                    <c:if test="${fn:length(bpmFormDialog.conditionList)>0 and bpmFormDialog.conditionList[0].defaultType ne 5}">
                                            ...
                                            <c:otherwise>
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <input type="hidden" name="${col.fieldName}" class="inputText" disabled="true"/>
                                                        <input type="hidden" name="${col.fieldName}ID" class="inputText" disabled="true" onchange="fieldIDChange(this)"/>
                                                        <input type="text" name="Q_${col.fieldName }_S" 
				                                            <c:forEach items="${paramsMap}" var="pm">
				                                                <c:if test="${pm.key==col.fieldName }">
				                                                     value="${pm.value }"
				                                                </c:if>
