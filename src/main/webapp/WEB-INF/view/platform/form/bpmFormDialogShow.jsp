...
<script type="text/javascript">
    ...
    function onChecked(obj,tr,textarea) {
        ...
        //设置中间变量，印章信息
        if(typeof (window.parent.setTempSealInfo) != 'undefined') {
            window.parent.setTempSealInfo(jsonStr);
        }
...
<body style="margin: 0;">
    <iframe src="showFrame.ht?<%=request.getQueryString()%>"
        ...
        frameborder="0"
        onload="this.height=document.body.scrollHeight - 3"></iframe>
        <!-- document.body.scrollHeight - 3 这里减3是由于ie浏览器对scrollHeight的高度与其他浏览器不统一，如果不减3会导致双滚动条-->
