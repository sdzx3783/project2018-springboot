...
<script type="text/javascript">
		...
		$(function() {
			...
			var  src="${ctx}/platform/system/sysOrg/selector.ht?isSingle=${param.isSingle}&type="+type+"&typeVal="+typeVal+"&allOrgs="+allOrgs;
...
<body>
	<div id="defLayout">
		<div  position="left" title="组织树" style="float: left;width: 100% !important;height:95%;;">
			...
			<ul id="orgTree" class="ztree" style="overflow:auto;height:80%;"></ul>
		</div>
		<div position="center">
