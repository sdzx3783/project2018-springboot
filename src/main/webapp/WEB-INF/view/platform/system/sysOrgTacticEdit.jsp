	...
	<script type="text/javascript">
		...
		function showResponse(responseText) {
			...
			if (obj.isSuccess()) {
				...
				$.ligerDialog.err("提示信息","保存公司策略失败!",obj.getMessage());
			}
		}
	...
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group"><a class="link run" id="orgTacticGen" href="javascript:void(0)"><span></span>生成分公司</a></div>
			</div>
		</div>
	</div>
