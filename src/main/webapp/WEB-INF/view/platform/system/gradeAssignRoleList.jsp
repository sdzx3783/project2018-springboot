...
<script type="text/javascript" src="${ctx }/static/platform/js/hotent/platform/system/GradeRoleSelectDialog.js"></script>
<script type="text/javascript">
	...
	if(scope=="grade"){
		reloadUrl=__ctx + "/platform/system/grade/assignRoleGradeList.ht?orgId=${orgId}&authId=${param.authId}&topOrgId=${param.topOrgId}";
