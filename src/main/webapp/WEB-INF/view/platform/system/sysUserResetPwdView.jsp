            ...
            <form id="sysUserForm" method="post" action="resetPwd.ht">
                <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td ><input type="text" onfocus="this.type='password'" id="newPassword" name="newPassword" style="width:255px !important" class="inputText"/></td>
                    </tr>
                    <tr>
                        <th width="20%">确认密码:  <span class="required">*</span></th>
                        <td ><input type="text" onfocus="this.type='password'" id="password" name="password" style="width:255px !important" class="inputText"/></td>
                    </tr>
                </table>
