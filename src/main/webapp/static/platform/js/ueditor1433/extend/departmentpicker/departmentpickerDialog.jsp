...
<script type="text/javascript" src="${ctx}/static/platform/js/ueditor1433/extend/departmentpicker/departmentpickerDialogController.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			var span;
			if (!targetEl) {//新增模式
				span = $("<span class='departmentpicker' parser='selectoredit'></span>");
				$(element).append(span);
			} else {//编辑
				span = $(targetEl);
				span.empty();
			...
			span.append("<input type='text' /><a href='javascript:;' class='link org'>" + scope.external.buttoncontent + "</a>");
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<label ng-if="external.singleselect=='1'">
							<input ng-model="external.showCurOrg" type="checkbox" style="width: 20px" ng-true-value="1" ng-false-value="0" />
							显示当前部门
						</label>
					</td>
				</tr>
