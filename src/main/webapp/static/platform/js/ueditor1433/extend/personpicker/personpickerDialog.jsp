...
<script type="text/javascript" src="${ctx}/static/platform/js/ueditor1433/extend/personpicker/personpickerDialogController.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			var span;
			if (!targetEl) {//新增模式
				span = $("<span class='personpicker' parser='selectoredit'></span>");
			...
			span.append("<input type='text' /><a href='javascript:;' class='link user'>" + scope.external.buttoncontent + "</a>");
				...
				<tr>
					...
					<td>
						...
						<label ng-if="external.singleselect=='1'">
							<input ng-model="external.showCurUser" type="checkbox" style="width: 20px" ng-true-value="1" ng-false-value="0" />
							显示当前用户
						</label>
					</td>
				</tr>
