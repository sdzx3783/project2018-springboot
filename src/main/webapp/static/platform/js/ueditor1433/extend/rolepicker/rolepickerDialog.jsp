...
<script type="text/javascript" src="${ctx}/static/platform/js/ueditor1433/extend/rolepicker/rolepickerDialogController.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			var span;
			if (!targetEl) {//新增模式
				span = $("<span class='rolepicker' parser='selectoredit'></span>");
			...
			span.append("<input type='text' /><a href='javascript:;' class='link role'>" + scope.external.buttoncontent + "</a>");
