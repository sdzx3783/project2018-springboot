...
<script type="text/javascript" src="${ctx}/static/platform/js/ueditor1433/extend/processinstance/processinstanceDialogController.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			var span;
			if (!targetEl) {//新增模式
				var span = $("<span class='processinstance' parser='proinstedit'></span>");
				$(element).append(span);
			} else {//编辑
				span=$(targetEl);
				span.empty();
			...
			input.attr("ctltype","selector");
			input.attr("class","actInsts");
