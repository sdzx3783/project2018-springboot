...
<script type="text/javascript" src="${ctx}/static/platform/js/ueditor1433/extend/selectinput/selectinputDialogController.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			var span;
			if (!targetEl) {//新增模式
				span = $("<span class='selectinput' parser='selectedit'></span>");
			...
			select.css("width",scope.external.width+scope.external.widthUnit);
			select.css("height",scope.external.height+scope.external.heightUnit);
