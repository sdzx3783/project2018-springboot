...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			var span;
			if (!targetEl) {//新增模式
				span = $("<span class='checkbox' parser='checkboxedit'></span>");
						...
						<table style="width: 100%">
							...
							<tr class="editable-tr" ng-repeat="item in external.options track by $index">
								<td>
									...
									默认:
									<input ng-model="item.isDefault" type="checkbox" style="width: 20px" ng-true-value="1" ng-false-value="0"/>
								</td>
								<td>
