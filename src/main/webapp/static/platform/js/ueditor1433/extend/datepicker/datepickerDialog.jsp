...
<script type="text/javascript" src="${ctx}/static/platform/js/ueditor1433/extend/datepicker/datepickerDialogController.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			var span;
			if (!targetEl) {//新增模式
				span = $("<span class='datepicker' parser='dateedit'></span>");
				$(element).append(span);
			} else {//编辑
				span=$(targetEl);
				span.empty();
		...
		<table class="edit_table">
			<tbody>
				...
				<tr>
					...
					<th>数据格式:</th>
					<!-- 日期类型 -->
					<td class="dbformat_td" ng-if="external.dbType.type=='date'">
						<select ng-model="external.dbType.format">
						...
						<label for="displayDate">
							<input id="displayDate" ng-model="external.dbType.displayDate" type="checkbox" ng-true-value="1" ng-false-value="0" />
							当前时间
						</label>
					</td>
				</tr>
