...
<script type="text/javascript" src="${ctx}/static/platform/js/easyui/jquery.easyui.min.js"></script>
<f:js pre="static/platform/js/lang/easyui" ></f:js>
<script type="text/javascript" src="${ctx}/static/platform/js/easyui/extend/jquery.easyui.topCall.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/easyui/extend/jquery.easyui.fixTreeFrame.js"></script>
...
<script type="text/javascript" src="${ctx}/static/platform/js/easyui/extend/DialogUtil.js" ></script>
<script type="text/javascript" src="${ctx}/static/platform/js/easyui/extend/formtterExt.js" ></script>
<script type="text/javascript" src="${ctx}/static/platform/js/easyui/extend/jquery.easyui.topCall.js"></script>
