...
<script type="text/javascript" src="${ctx}/static/platform/js/hotent/platform/form/CustomForm.js"></script>
...
<script type="text/javascript" src="${ctx}/static/platform/js/hotent/platform/form/SubtablePermission.js"></script>
...
<script type="text/javascript" src="${ctx}/static/platform/js/ntkoWebSign/NtkoWebSign.js"></script>
...
<script type="text/javascript" src="${ctx}/static/platform/js/hotent/platform/form/FormDate.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/hotent/platform/form/FormUtil.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/hotent/platform/form/FormExcel.js"></script>
...
<script type="text/javascript" src="${ctx}/static/platform/js/hotent/platform/form/FormInit.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/hotent/platform/form/RunAliasScript.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/hotent/platform/form/bpmFormDialogCombinate/CombinateDialogUtil.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/hotent/platform/system/Share.js"></script>

<script type="text/javascript" src="${ctx}/static/platform/js/makshi/asset.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/makshi/userInfo.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/makshi/qualification.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/makshi/political.js"></script>
