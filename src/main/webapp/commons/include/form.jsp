...
<f:js pre="static/platform/js/lang/view/platform/system" ></f:js>
...
<script type="text/javascript" src="${ctx}/static/platform/js/jquery/jquery.validate.min.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/jquery/additional-methods.min.js"></script>
<script type="text/javascript" src="${ctx}/static/platform/js/jquery/jquery.validate.ext.js"></script>
