...
import com.hotent.core.bpmn20.entity.bpmndi.BPMNPlane;
...
public class ObjectFactory {
	private static final QName _BPMNLabelStyle_QNAME = new QName("http://www.omg.org/spec/BPMN/20100524/DI",
			"BPMNLabelStyle");
	...
	private static final QName _BPMNDiagram_QNAME = new QName("http://www.omg.org/spec/BPMN/20100524/DI",
			"BPMNDiagram");
	...
	public JAXBElement<BPMNLabelStyle> createBPMNLabelStyle(BPMNLabelStyle value) {
		return new JAXBElement(_BPMNLabelStyle_QNAME, BPMNLabelStyle.class, (Class) null, value);
	}
	...
	public JAXBElement<BPMNLabel> createBPMNLabel(BPMNLabel value) {
		return new JAXBElement(_BPMNLabel_QNAME, BPMNLabel.class, (Class) null, value);
	}
	...
	public JAXBElement<BPMNEdge> createBPMNEdge(BPMNEdge value) {
		return new JAXBElement(_BPMNEdge_QNAME, BPMNEdge.class, (Class) null, value);
	}
	...
	public JAXBElement<BPMNDiagram> createBPMNDiagram(BPMNDiagram value) {
		return new JAXBElement(_BPMNDiagram_QNAME, BPMNDiagram.class, (Class) null, value);
	}
	...
	public JAXBElement<BPMNShape> createBPMNShape(BPMNShape value) {
		return new JAXBElement(_BPMNShape_QNAME, BPMNShape.class, (Class) null, value);
	}
	...
	public JAXBElement<BPMNPlane> createBPMNPlane(BPMNPlane value) {
		return new JAXBElement(_BPMNPlane_QNAME, BPMNPlane.class, (Class) null, value);
	}
}