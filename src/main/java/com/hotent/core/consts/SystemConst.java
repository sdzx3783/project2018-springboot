...
public class SystemConst {
	...
	public static final Short BEGIN_TYPE = Short.valueOf(1);
	public static final Long BEGIN_ORGSUPID = Long.valueOf(-1L);
	public static final Short BEGIN_SN = Short.valueOf(1);
	public static final Short BEGIN_FROMTYPE = Short.valueOf(0);
	...
	public static final Short UN_LOCKED = Short.valueOf(0);
	public static final Short LOCKED = Short.valueOf(1);
	public static final Short UN_EXPIRED = Short.valueOf(0);
	public static final Short EXPIRED = Short.valueOf(1);
	public static final Short STATUS_OK = Short.valueOf(1);
	public static final Short STATUS_NO = Short.valueOf(0);
	public static final Short STATUS_Del = Short.valueOf(-1);
	public static final Short FROMTYPE_DB = Short.valueOf(0);
	public static final Short FROMTYPE_AD = Short.valueOf(1);
	public static final Short FROMTYPE_AD_SET = Short.valueOf(2);
