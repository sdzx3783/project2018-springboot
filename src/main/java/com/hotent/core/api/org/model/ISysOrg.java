...
public interface ISysOrg {
	...
	String BEGIN_PATH = "1";
	Short BEGIN_TYPE = Short.valueOf((short) 1);
	Long BEGIN_ORGSUPID = Long.valueOf(-1L);
	Short BEGIN_SN = Short.valueOf((short) 1);
	Short BEGIN_FROMTYPE = Short.valueOf((short) 0);
	Short FROMTYPE_AD = Short.valueOf((short) 1);
	Short FROMTYPE_DB = Short.valueOf((short) 0);
