...
public class Resources extends BaseModel implements Cloneable
{
	...
	private String resOrgIds;
	private boolean resChoose;
	...
	public String getResOrgIds() {
		return resOrgIds;
	}
	public void setResOrgIds(String resOrgIds) {
		this.resOrgIds = resOrgIds;
	}
	public boolean getResChoose() {
		return resChoose;
	}
	public void setResChoose(boolean resChoose) {
