...
public class ResourcesDao extends BaseDao<Resources>
{
	 ...
	 * @return
	 */
	public List<Resources> getOrgResByParentId(long parentId){
		return this.getBySqlKey("getOrgResByParentId", parentId);
	}
	...
	/**
	 * 根据系统id和当前用户角色，选择部门获取资源菜单
	 * @param systemId
	 * @param roles
	 * @return
	 */
	public List<Resources> getNormMenuByRoleAndOrg(long systemId,Long userId){
		Map<String, Object> p=new HashMap<String, Object>();
		p.put("systemId", systemId);
		p.put("userId", userId);
		return this.getBySqlKey("getNormMenuByRoleAndOrg", p);
	}
	...
	/**
	 * 根据系统id和当前用户角色(自己和所属于部门的所有角色)和选择部门菜单
	 * @param systemId
	 * @param roles
	 * @return
	 */
	public List<Resources> getNormMenuByAllRoleAndOrg(long systemId,String rolealias){
		Map<String, Object> p=new HashMap<String, Object>();
		p.put("systemId", systemId);
		p.put("rolealias", rolealias);
		return this.getBySqlKey("getNormMenuByAllRoleAndOrg", p);
	}
	 ...
	 * @return
	 */
	public List<Resources> getSuperMenuByAllRoleAndOrg(long systemId){
		Map<String, Object> p=new HashMap<String, Object>();
		p.put("systemId", systemId);
		return this.getBySqlKey("getSuperMenuByAllRoleAndOrg", p);
	}
